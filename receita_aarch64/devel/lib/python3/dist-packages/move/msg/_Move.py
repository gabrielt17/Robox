...
"""autogenerated by genpy from move/Move.msg. Do not edit."""
import codecs
import sys
...
class Move(genpy.Message):
  _md5sum = "efe20d682e9038d97b30d36a75eea378"
  _type = "move/Move"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """string direction
int32 power"""
  __slots__ = ['direction','power']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.power,) = _get_struct_i().unpack(str[start:end])
      return self
